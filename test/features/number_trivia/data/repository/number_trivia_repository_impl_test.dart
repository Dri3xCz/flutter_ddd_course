...
void main() {
  ...
  late MockNumberTriviaMapper mockNumberTriviaMapper;
  ...
  setUp(
    () => {
      ...
      mockNumberTriviaMapper = MockNumberTriviaMapper(),
      repository = NumberTriviaRepositoryImpl(
        remoteDataSource: mockNumberTriviaRemoteDataSource,
        localDataSource: mockNumberTriviaLocalDataSource,
        networkInfo: mockNetworkInfo,
        numberTriviaMapper: mockNumberTriviaMapper,
      ),
    },
  );
  ...
  group('getConcreteNumberTrivia', () {
    ...
    setUp(
      () => {setUpNumberTriviaMapper(tNumberTriviaModel, tNumberTrivia)},
    );
